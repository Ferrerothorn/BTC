...
public class RunTourney {
	...
	private static void showCredits() {
		...
		GUI.postString("(Version 13.2.1 - Made by Steve Dolman)");
		GUI.postString("Shoutout to Sera-Jane Cooley, Rachel Dolman, Darren Macey for help in testing and debug - #NAK4LYF!");
	}
}
